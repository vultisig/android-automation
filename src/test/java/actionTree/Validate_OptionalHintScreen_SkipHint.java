...
public class Validate_OptionalHintScreen_SkipHint extends BaseTest {

    private static final Logger logger = Logger.getLogger(Validate_OptionalHintScreen_SkipHint.class.getName());

    @Test(description = "Validate Optional Hint screen by skipping the Hint")
    public void Validate_OptionalHintScreen_SkipHint() throws InterruptedException {
        ...
        // ---------------------- VaultNameScreen (navigate back and forward) ----------------------
        ...
        Thread.sleep(3000);
        logger.info("🎉 Optional hint (skip) flow completed successfully");
    }
}
