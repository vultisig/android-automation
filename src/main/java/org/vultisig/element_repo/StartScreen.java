...
public class StartScreen extends BaseScreen {
    ...
    // 🔹 Scan QR button
    @AndroidFindBy(xpath = "//android.widget.TextView[@text='OR']/parent::android.view.View/android.view.View[2]")
    private WebElement scanQRButton;

    // 🔹 Import Vault button
    @AndroidFindBy(xpath = "//android.widget.TextView[@text='OR']/parent::android.view.View/android.view.View[3]")
